                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">Dibuat oleh: <span
                                                class="font-weight-bold">{{ $transaksi->user->nama }}</span></td>
                                    </tr>
                                    <tr>
                                        <td>{{ $transaksi->penjualan_kode }}</td>
                                        <td class="text-right">Sebagai: <span
                                                class="font-weight-bold">{{ $transaksi->user->level->level_name }}</span></td>
                                    </tr>
                                    <tr>
                                        ...
                                        @if ($transaksi->updated_by != null)
                                            <td class="text-right">Diedit oleh: <span
                                                    class="font-weight-bold">{{ $transaksi->updatedBy->nama }}</span>
                                            </td>
                                        @endif
                                    </tr>
                                    @if ($transaksi->updated_by != null)
                                        <tr>
                                            ...
                                            <td class="text-right">Diedit pada: <span
                                                    class="font-weight-bold">{{ $transaksi->updated_at }}<span
